      ...
      (set, get) => ({
        ...
        setUserProperties: (properties: Partial<UserProperties>) => {
          set(state => {
            ...
            // Determine user segment based on properties let segment = 'new'; if (newProperties.usageDays > 30) segment = 'power'; else if (newProperties.usageDays > 7) segment = 'regular'; else if (newProperties.sessionCount > 5) segment = 'engaged';
