...
export async function initializeAllServices(): Promise<void> {
  ...
  try {
    // Initialize automation service const { initializeAutomationService } = await import('./automation.service');
    initializeAutomationService();
...
export async function cleanupAllServices(): Promise<void> {
  ...
  try {
    // Cleanup automation service const { cleanupAutomationService } = await import('./automation.service');
    cleanupAutomationService();
