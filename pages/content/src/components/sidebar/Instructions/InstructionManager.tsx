...
// Create a global shared state for instructions const logger = createLogger('InstructionManager');
...
const InstructionManager: React.FC<InstructionManagerProps> = ({ adapter, tools }) => {
  ...
  // Custom instructions state - get from preferences const [customInstructions, setCustomInstructions] = useState(preferences.customInstructions || '');
