...
//     attachFile,
//     isReady
//   } = useCurrentAdapter(); //   // Create a bridge object that implements the old SiteAdapter interface
...
//     logMessage(`[AdapterBridge] Falling back to old adapter system due to error: ${error}`); //     // Import the old useSiteAdapter only when needed
